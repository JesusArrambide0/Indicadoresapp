...
with tab5:
    ...
    # 🔄 Mostrar alertas solo dentro de tab5
    if alertas:
        agentes_con_alertas = sorted(set(a.split()[1] for a in alertas))  # Esto funciona solo si los nombres son de una sola palabra
